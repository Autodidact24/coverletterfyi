    ...
    <div className="flex max-w-5xl mx-auto flex-col items-center justify-center py-2 min-h-screen">
      ...
      <main className="flex flex-1 w-full flex-col items-center justify-center text-center px-4 mt-12 sm:mt-20">
        <h1 className="sm:text-6xl text-4xl max-w-[708px] font-bold text-slate-900">
          Generate Cover Letters for your Job Applications
        </h1>
        <p className="text-slate-500 mt-5">5000+ Cover Letters generated so far.</p>
        <div className="max-w-xl w-full">
          ...
          <div className="max-w-xl w-full">
            ...
            Enter the job description{" "}
              <span className="text-slate-500">
                (or write a few sentences about the job)
              </span>
            .
            </p>
          </div>
          ...
          {!loading && (
            ...
            >
              Generate the Cover Letter &rarr;
            </button>
          )}
          {loading && (
            <button
          ...
          {generatedCoverLetter && (
            <>
              ...
              <div className="space-y-8 flex flex-col items-center justify-center max-w-xl mx-auto">
                {generatedCoverLetter
                  .substring(generatedCoverLetter.indexOf("1") + 3)
                  .split("2.")
                  .map((generatedCoverLetter) => {
                    return (
                      <div
